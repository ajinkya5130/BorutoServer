...
const val PREV_PAGE_CONSTANT = "prevPage"
const val NEXT_PAGE_CONSTANT = "nextPage"
...
class HeroRepositoryImpl : HeroRepository {
    ...
    override suspend fun getAllHeroes(page: Int): ApiResponse {
        ...
        return ApiResponse(
            success = true,
            "Ok",
            prevPage = calculatePage(page)[PREV_PAGE_CONSTANT],
            nextPage = calculatePage(page)[NEXT_PAGE_CONSTANT],
            heroes = heroes[page]!!
        )
    }
    ...
    private fun calculatePage(page: Int): Map<String, Int?> {
        ...
        return mapOf(PREV_PAGE_CONSTANT to prevPage, NEXT_PAGE_CONSTANT to nextPage)
    }

    override suspend fun searchHeroes(name: String?): ApiResponse {

        return ApiResponse(success = true, message = "Ok", heroes = findHero(name))

    }

    private fun findHero(name: String?): List<HeroModel> {
        val foundList = mutableListOf<HeroModel>()
